...
epoch_url=${1:-"https://nexus.prd.oasis.io/v1/consensus/epochs?limit=1"}
validator_history_url=${2:-"https://nexus.prd.oasis.io/v1/consensus/validators/oasis1qq3xrq0urs8qcffhvmhfhz4p0mu7ewc8rscnlwxe/history?limit=1"}
